...
BOARD_PLAT_PRIVATE_SEPOLICY_DIR += \
    device/oneos/sepolicy/qcom/private

ifeq ($(TARGET_USES_PREBUILT_VENDOR_SEPOLICY), true)
BOARD_PLAT_PRIVATE_SEPOLICY_DIR += \
    device/oneos/sepolicy/qcom/dynamic \
    device/oneos/sepolicy/qcom/system
else
BOARD_VENDOR_SEPOLICY_DIRS += \
    device/oneos/sepolicy/qcom/dynamic \
    device/oneos/sepolicy/qcom/vendor
endif
